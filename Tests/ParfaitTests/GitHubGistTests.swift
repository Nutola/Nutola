...
final class GitHubGistTests: XCTestCase {
    ...
    // MARK: - renderedURL (opaque notes.parfait.to token)
    ...
    func testMapsModernThirtyTwoHexGist() {
        ...
        XCTAssertEqual(
            ...
            "https://notes.parfait.to/C2NvbnJhZC12YW5sASNFZ4mrze8BI0VniavN76vN7wEjRWeJq83vASNFZ4mrze8B")
    }
    ...
    func testMapsLegacyTwentyHexGist() {
        ...
        XCTAssertEqual(
            GitHubGist.renderedURL(fromRaw: raw)?.absoluteString,
            "https://notes.parfait.to/C2NvbnJhZC12YW5sASNFZ4mrze8BI6vN7wEjRWeJq83vASNFZ4mrze8B")
    }
